...
namespace FirmaXadesNet.Upgraders
{
    class XadesXLUpgrader : IXadesUpgrader
    {
        ...
        private void AddCertificate(X509Certificate2 cert, UnsignedProperties unsignedProperties, bool addCert,  System.Collections.Generic.IEnumerable<OcspServer> ocspServers,
            System.Collections.Generic.IEnumerable<X509Crl> crlList, FirmaXadesNet.Crypto.DigestMethod digestMethod, bool addCertificateOcspUrl, X509Certificate2[] extraCerts = null)
        {
            if (addCert)
            {
        ...
        private bool ValidateCertificateByCRL(UnsignedProperties unsignedProperties, X509Certificate2 certificate, X509Certificate2 issuer,
            System.Collections.Generic.IEnumerable<X509Crl> crlList, FirmaXadesNet.Crypto.DigestMethod digestMethod)
        {
        ...
        private X509Certificate2[] ValidateCertificateByOCSP(UnsignedProperties unsignedProperties, X509Certificate2 client, X509Certificate2 issuer,
            System.Collections.Generic.IEnumerable<OcspServer> ocspServers, FirmaXadesNet.Crypto.DigestMethod digestMethod, bool addCertificateOcspUrl)
        {
            bool byKey = false;
        ...
        /// </summary>
        /// <param name="unsignedProperties"></param>
        private void AddTSACertificates(UnsignedProperties unsignedProperties, System.Collections.Generic.IEnumerable<OcspServer> ocspServers, System.Collections.Generic.IEnumerable<X509Crl> crlList, FirmaXadesNet.Crypto.DigestMethod digestMethod, bool addCertificateOcspUrl)
        {
            ...
            IStore<Org.BouncyCastle.X509.X509Certificate> store = token.GetCertificates();
